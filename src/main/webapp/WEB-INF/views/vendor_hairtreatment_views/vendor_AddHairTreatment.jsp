...
<head>
    ...
    <meta charset="UTF-8">
    <title>Add Hair Treatment | Vendor </title>
...
<div id="main" style=" background: linear-gradient( rgba(0, 0, 0, 0.3),rgba(0, 0, 0, 0.3)),
    ...
    <div class="container">
        <form class="form-horizontal" id="addHairTreatmentForm" action='addHairTreatmentForm' method="POST"
              enctype="multipart/form-data">
            <div class="well well-lg" style="margin: 1%; border-radius: 0; box-shadow: 0 0 30px black;">
                <h1 style="text-align: center;">Add Hair Treatment Details</h1><br/>
                <fieldset>
                    <legend></legend>
                    <div id="addImages">
                            ...
                            <div class="picture-container">
                                <div class="picture">
                                    ...
                                    <input class="form-control" name="files" type="file" id="addImgBtn1"
                                           title="Add Hair Treatment Image 1" accept=".jpg,.png,.jpeg"/>
                                    <div id="addImage1Label1">
                                        <label>Add Hair Treatment Image 1</label><br/>
                            ...
                            <div class="picture-container">
                                <div class="picture">
                                    ...
                                    <input class="form-control" name="files" type="file" id="addImgBtn2"
                                           title="Add Hair Treatment Image 2" accept=".jpg,.png,.jpeg"/>
                                    <div id="addImage2Label2">
                                        <label>Add Hair Treatment Image 2</label><br/>
                                        <small>Preferred Size: 400 x 350</small>
                                    </div>
                            ...
                            <div class="picture-container">
                                <div class="picture">
                                    ...
                                    <input class="form-control" name="files" type="file" id="addImgBtn3"
                                           title="Add Hair Treatment Image 3" accept=".jpg,.png,.jpeg"/>
                                    <div id="addImage3Label3">
                                        <label>Add Hair Treatment Image 3</label><br/>
                                        <small>Preferred Size: 400 x 350</small>
                                    </div>
                    ...
                    <div class="col-xs-12 col-md-12 col-lg-12 form-group">
                        <label class="col-xs-2 col-md-2 col-lg-2">Hair Treatment Name</label>
                        <div class="col-xs-4 col-md-4 col-lg-4">
                            <input name="htName" type="text" id="htName" placeholder=""
                                   class="form-control name">
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-12 col-lg-12 form-group">
                        <label class="col-xs-2 col-md-2 col-lg-2">Hair Treatment For</label>
                        <div class="col-xs-4 col-md-4 col-lg-4">
                            <input type="radio" checked name="htFor" class="input-xlarge"
                    ...
                    <div class="col-xs-12 col-md-12 col-lg-12 form-group">
                        ...
                        <div class="col-xs-4 col-md-4 col-lg-4">
                            <input type="number" name="htQty" step="0.10" placeholder="0.00"
                                   class="form-control name">
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-12 col-lg-12 form-group">
                        ...
                        <div class="col-xs-4 col-md-4 col-lg-4">
                            <input type="number" name="htPrice" placeholder="" class="form-control name">
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-12 col-lg-12 form-group">
                        <label class="col-xs-2 col-md-2 col-lg-2">Discount</label>
                        <div class="col-xs-4 col-md-4 col-lg-4">
                            <input type="number" name="htDiscount" step="0.01" placeholder="0.00" max="1"
                                   class="form-control name">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4 col-md-4 col-lg-4">
                            <button id="submit" type="submit" class="btn btn-primary acount-btn">ADD HAIR TREATMENT
                            </button>
                            &nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;
