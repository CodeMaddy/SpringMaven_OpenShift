...
<head>
    ...
    <meta charset="UTF-8">
    <title>View Hair Treatment | Vendor </title>
...
<div id="main">
        ...
        <div class="row">
            ...
            <div class="col-xs-10 col-md-10 col-lg-10" style="margin-top:1%;">
                <div class="well well-lg" style="padding: 2%;">
                    ...
                    <h3 style="display: inline-block">Hair Treatments</h3>&nbsp;
                    <div class="btn-group">
                    ...
                    <c:choose>
                        <c:when test="${hairtreatments.size() == 0}">
                            <div>
                                <h1>No Hair Treatments are available </h1>
                                <h1> Please add Hair Treatments</h1>
                            </div>

                        </c:when>
                        <c:otherwise>
                            <small style="display: block;"><em>Showing 1 - ${hairtreatments.size()}
                                of ${hairtreatments.size()} Results</em>
                            </small>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-7 col-lg-7">
                                                        <div class="modal-title">
                                                            <h3>${hairtreatments.get(i).htName}</h3></div>
                                                        </p>
                                                        <p><strong>Description</strong></p>
                                                        <p> ${hairtreatments.get(i).htDesc} </p>
                                                        <p><strong>Actual
                                                            Price&nbsp;:&nbsp;</strong>${hairtreatments.get(i).htPrice}
                                                        </p>
                                                        <p>
                                                        ...
                                                        <div class="modal-footer">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xs-6">
                                                                    <div class="row">
                                                                        <div class="col-xs-4">
                                                                            <form action="EditHairTreatmentDetails"
                                                                                  method="get">
    ...
    <div class="right-corder-container">
        <a href="AddHairTreatment" class="btn right-corder-container-button">
            <span class="short-text">+</span>
            <span class="long-text">ADD HAIR TREATMENT</span>
        </a>
    </div>
</div>
<%--<% }%>--%>
