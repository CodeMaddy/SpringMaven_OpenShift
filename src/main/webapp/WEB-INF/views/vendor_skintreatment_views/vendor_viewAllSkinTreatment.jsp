...
<head>
    ...
    <meta charset="UTF-8">
    <title>View Skin Treatments | Vendor </title>
...
<div id="main">
        ...
        <div class="row">
            ...
            <div class="col-xs-10 col-md-10 col-lg-10" style="margin-top:1%;">
                <div class="well well-lg" style="padding: 2%;">
                    <h3 style="display: inline-block">Skin Treatments</h3>&nbsp;
                    <div class="btn-group">
                        ...
                        <c:otherwise>
                            ...
                            <div id="products" class="row list-group">
                                <c:forEach var="i" begin="0" end="${skinTreatments.size()-1}">
                                    ...
                                    <!-- BEGIN # MODAL -->
                                    <div class="modal fade detail-modal" id="${skinTreatments.get(i).stId}"
                                         tabindex="-1"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-7 col-lg-7">
                                                        <div class="modal-title">
                                                            <h3>${skinTreatments.get(i).stName}</h3></div>
                                                        </p>
                                                        <p><strong>Description</strong></p>
                                                        <p> ${skinTreatments.get(i).stDesc} </p>
                                                        <p><strong>Actual
                                                            Price&nbsp;:&nbsp;</strong>${skinTreatments.get(i).stPrice}
                                                        </p>
                                                        <p>
    ...
    <div class="right-corder-container">
        <a href="AddSkinTreatment" class="btn right-corder-container-button">
            <span class="short-text">+</span>
            <span class="long-text">ADD SKIN TREATMENT</span>
        </a>
    </div>
</div>
<%--<% }%>--%>
