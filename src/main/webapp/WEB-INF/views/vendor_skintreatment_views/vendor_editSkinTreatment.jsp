...
<head>
    ...
    <meta charset="UTF-8">
    <title>Edit Skin Treatment | Vendor </title>
...
<div id="main" style=" background: linear-gradient( rgba(0, 0, 0, 0.3),rgba(0, 0, 0, 0.3)),
    ...
    <div class="container">
        <form class="form-horizontal" id="addSkinTreatmentForm" action='updateSkinTreatmentForm' method="POST"
              enctype="multipart/form-data">
            <div class="well well-lg" style="margin: 1%; border-radius: 0; box-shadow: 0 0 30px black;">
                <h1 style="text-align: center;">EDIT SKIN TREATMENT DETAILS</h1><br/>
                <fieldset>
                    <legend></legend>
                    <div id="addImages">
    ...
    box-shadow: 0.5px 0.5px 0.5px 0.5px #888888;">
                            <div class="picture-container">
                                <div class="picture">
                                    ...
                                    <img src="<%=path%>/showImage/${skinTreatment.stPics[0]}" class="picture-src"
    ...
    box-shadow: 0.5px 0.5px 0.5px 0.5px #888888;">
                            <div class="picture-container">
                                <div class="picture">
                                    ...
                                    <img src="<%=path%>/showImage/${skinTreatment.stPics[1]}" class="picture-src"
    ...
    box-shadow: 0.5px 0.5px 0.5px 0.5px #888888;">
                            <div class="picture-container">
                                <div class="picture">
                                    ...
                                    <img src="<%=path%>/showImage/${skinTreatment.stPics[2]}" class="picture-src"
                    ...
                    <div class="col-xs-12 col-md-12 col-lg-12 form-group">
                        ...
                        <div class="col-xs-4 col-md-4 col-lg-4">
                            <input name="stName" type="text" id="stName" value="${skinTreatment.stName}"
                    ...
                    <div class="col-xs-12 col-md-12 col-lg-12 form-group">
                        ...
                        <div class="col-xs-4 col-md-4 col-lg-4">
                            <c:choose>
                                <c:when test="${skinTreatment.stFor == 'Men'}">
                    ...
                    <div class="col-xs-12 col-md-12 col-lg-12 form-group margin50">
                        ...
                        <div class="col-xs-4 col-md-4 col-lg-4">
                            <textarea rows="6"  name="stDesc"
                                      class="form-control name">${skinTreatment.stDesc}</textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-md-12 col-lg-12 form-group">
                        ...
                        <div class="col-xs-4 col-md-4 col-lg-4">
                            <input type="number" name="stPrice" value="${skinTreatment.stPrice}" class="form-control name">
                        </div>
                    </div>
                    <div class="col-xs-12 col-md-12 col-lg-12 form-group">
                        <label class="col-xs-2 col-md-2 col-lg-2">Discount</label>
                        <div class="col-xs-4 col-md-4 col-lg-4">
                            <input type="number" name="stDiscount" step="0.01" value="${skinTreatment.stDiscount}" max="1"
                                   class="form-control name">
                        </div>
                    </div>
                    <div class="row"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4 col-md-4 col-lg-4">
                            <button id="submit" type="submit" class="btn btn-primary acount-btn">UPDATE SKIN TREATMENT
                            </button>
                            &nbsp;&nbsp;&nbsp;
                            &nbsp;&nbsp;&nbsp;
