...
<head>
    ...
    <title>Skin treatment Booking | Set Your Style</title>
    <!-- core CSS -->
...
<div class="container" style="margin-top: 80px">
    <div class="row">
        ...
        <div class="col-md-3 well" style="margin-top:100px;margin-left: 60px;width: 300px;">
            <input type="text" class="form-control" id="selectedSkinName" placeholder="${skintreatment.toString()}"
                   style="height: 90px;font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif;
                   font-size: 30px;"><br>
            <input type="text" class="form-control" id="priceMoney"
                   placeholder="${price}"
                   style="height: 40px;
...
//       var name = sessionStorage.getItem("skinkwy")
//        var hname = name.split(" ");
//        var skin = hname[0];
//        var price = hname[hname.length-1];
//        alert(price+ " "+skin);
//        $('#selectedSkinName').val(skin);
//        $('#priceMoney').val(price);
