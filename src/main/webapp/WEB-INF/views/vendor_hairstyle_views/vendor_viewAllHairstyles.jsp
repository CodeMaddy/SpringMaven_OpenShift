...
<head>
    ...
    <meta charset="UTF-8">
    <title>View HairStyles | Vendor</title>
...
<div id="main">
        ...
        <div class="row">
            ...
            <div class="col-xs-10 col-md-10 col-lg-10" style="margin-top:1%;">
                <div class="well well-lg" style="padding: 2%;">
                    ...
                    <h3 style="display: inline-block">Hairstyles</h3>&nbsp;
                    <div class="btn-group">
                        ...
                        <c:otherwise>
                            ...
                            <div id="products" class="row list-group">
                                <c:forEach var="i" begin="0" end="${hairstyles.size()-1}">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 col-md-6">
                                                        <a class="btn btn-success" data-toggle="modal"
                                                           data-target="#${hairstyles.get(i).hairstyleId}"
                                                           href="">View Details</a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <!-- BEGIN # MODAL -->
                                    <div class="modal fade detail-modal" id="${hairstyles.get(i).hairstyleId}"
                                         tabindex="-1"
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div id='carousel-custom' class='carousel slide'
                                                                ...
                                                                <div class='carousel-outer'>
                                                                    ...
                                                                    <div class='carousel-inner '>
                                                                        <div class='item active'>
                                                                            <img src='<%=path%>/showImage/${hairstyles.get(i).hairstylePics[0]}'
                                                                                 alt='' id="zoom_05"
                                                                                 data-zoom-image="/showImage/${hairstyles.get(i).hairstylePics[0]}"/>
                                                                        </div>
                                                                        <div class='item' id="zoom_0">
                                                                            <img src='<%=path%>/showImage/${hairstyles.get(i).hairstylePics[1]}'
                                                                                 alt=''
                                                                                 data-zoom-image="/showImage/${hairstyles.get(i).hairstylePics[1]}"/>
                                                                        </div>
                                                                        <div class='item'>
                                                                            <img src='<%=path%>/showImage/${hairstyles.get(i).hairstylePics[2]}'
                                                                                 alt=''
                                                                                 data-zoom-image="/showImage/${hairstyles.get(i).hairstylePics[2]}"/>
                                                                        </div>
                                                                ...
                                                                <ol class='carousel-indicators mCustomScrollbar meartlab'>
                                                                    <li data-target='#carousel-custom' data-slide-to='0'
                                                                        class='active'><img
                                                                            src='<%=path%>/showImage/${hairstyles.get(i).hairstylePics[0]}'
                                                                            alt=''/></li>
                                                                    <li data-target='#carousel-custom'
                                                                        data-slide-to='1'><img
                                                                            src='<%=path%>/showImage/${hairstyles.get(i).hairstylePics[1]}'
                                                                            alt=''/></li>
                                                                    <li data-target='#carousel-custom'
                                                                        data-slide-to='2'><img
                                                                            src='<%=path%>/showImage/${hairstyles.get(i).hairstylePics[2]}'
                                                                            alt=''/></li>
                                                                </ol>
                                                            </div>
                                                    ...
                                                    <div class="col-xs-7 col-lg-7">
                                                        <div class="modal-title">
                                                            <h3>${hairstyles.get(i).hairstyleName}</h3></div>
                                                        <p><%=vendor.getAddr1()%>,&nbsp; <%=vendor.getLandmark()%>,&nbsp; <%=vendor.getCity()%>
                                                        </p>
                                                        <p><strong>Description</strong></p>
                                                        <p> ${hairstyles.get(i).hairstyleDescription} </p>
                                                        <p><strong>Actual
                                                            Price&nbsp;:&nbsp;</strong>${hairstyles.get(i).actualPrice}
                                                        </p>
                                                        <p>
                                                            <strong>Discount&nbsp;:&nbsp;</strong>${hairstyles.get(i).discount}
                                                        </p>
                                                        <div class="modal-footer">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-xs-6">
                                                                    <div class="row">
                                                                        <div class="col-xs-4">
                                                                            <form action="EditHairstyleDetails" method="get">
                                                                                <input type="hidden" name="hId" value="${hairstyles.get(i).hairstyleId}">
                                                                                <button type="submit"
    ...
    <div class="right-corder-container">
        <a href="AddHairstyle" class="btn right-corder-container-button">
            <span class="short-text">+</span>
            <span class="long-text">ADD HAIR STYLE</span>
        </a>
    </div>
</div>
<%--<% }%>--%>
