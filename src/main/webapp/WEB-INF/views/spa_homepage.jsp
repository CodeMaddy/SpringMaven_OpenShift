...
<head>
    ...
    <title>Spa | Set Your Style</title>
                ...
                <div class="well well-lg" style="padding: 2%;">
                    ...
                    <c:choose>
                        <c:when test="${spa.size() == 0}">
                            <div>
                                <h1>No spa Treatments available</h1>
                            </div>
                        ...
                        <c:otherwise>
                            ...
                            <div id="products" class="row list-group">
                                <c:forEach var="i" begin="0" end="${spa.size()-1}">
                                    ...
                                    <!-- BEGIN # MODAL -->
                                    <div class="modal fade detail-modal" id="${spa.get(i).spaId}"
                                         tabindex="-1"
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div id='carousel-custom' class='carousel slide'
                                                                ...
                                                                <div class='carousel-outer'>
                                                                    ...
                                                                    <div class='carousel-inner '>
                                                                        <div class='item active'>
                                                                            <img src='<%=path%>/showImage/${spa.get(i).spaPics[0]}'
                                                                                 alt='' id="zoom_05"
                                                                                 data-zoom-image="/showImage/${spa.get(i).spaPics[0]}"/>
                                                                        </div>
                                                                        <div class='item' id="zoom_0">
                                                                            <img src='<%=path%>/showImage/${spa.get(i).spaPics[1]}'
                                                                                 alt=''
                                                                                 data-zoom-image="/showImage/${spa.get(i).spaPics[1]}"/>
                                                                        </div>
                                                                        <div class='item'>
                                                                            <img src='<%=path%>/showImage/${spa.get(i).spaPics[2]}'
                                                                                 alt=''
                                                                                 data-zoom-image="/showImage/${spa.get(i).spaPics[2]}"/>
                                                                        </div>
                                                                ...
                                                                <ol class='carousel-indicators mCustomScrollbar meartlab'>
                                                                    <li data-target='#carousel-custom' data-slide-to='0'
                                                                        class='active'><img
                                                                            src='<%=path%>/showImage/${spa.get(i).spaPics[0]}'
                                                                            alt=''/></li>
                                                                    <li data-target='#carousel-custom'
                                                                        data-slide-to='1'><img
                                                                            src='<%=path%>/showImage/${spa.get(i).spaPics[1]}'
                                                                            alt=''/></li>
                                                                    <li data-target='#carousel-custom'
                                                                        data-slide-to='2'><img
                                                                            src='<%=path%>/showImage/${spa.get(i).spaPics[2]}'
                                                                            alt=''/></li>
                                                                </ol>
                                                            </div>
                                                    ...
                                                    <div class="col-xs-7 col-lg-7">
                                                        <div class="modal-title">
                                                            <h3>${spa.get(i).spaName}</h3></div>
                                                        <p><strong>Description</strong></p>
                                                        <p> ${spa.get(i).spaDesc} </p>
                                                        <p><strong>Actual
                                                            Price&nbsp;:&nbsp;</strong>${spa.get(i).spaPrice}
                                                        </p>
                                                        <p>
                                                            <strong>Discount&nbsp;:&nbsp;</strong>${spa.get(i).spaDiscount}
                                                        </p>
